...
public class Jose4j {
    ...
    public void keyGenerator() throws Exception {
        ...
        System.out.println("ECDSA private: " + Base64.getEncoder().encodeToString(senderJwk.getEcPrivateKey().getEncoded()));
        System.out.println("ECDSA public: " + Base64.getEncoder().encodeToString(senderJwk.getECPublicKey().getEncoded()));
...
//        EllipticCurveJsonWebKey senderJwk = EcJwkGenerator.generateJwk(EllipticCurves.P256);
        ...
        AlgorithmConstraints algConstraints = new AlgorithmConstraints(AlgorithmConstraints.ConstraintType.PERMIT, alg);
        AlgorithmConstraints encConstraints = new AlgorithmConstraints(AlgorithmConstraints.ConstraintType.PERMIT, encryptionAlgorithm);
