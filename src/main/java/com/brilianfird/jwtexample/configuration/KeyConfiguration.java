...
public class KeyConfiguration {
    ...
    @Bean
    public PublicJsonWebKey ecdsaPublicJsonWebKey() throws NoSuchAlgorithmException, JoseException, InvalidKeySpecException {
        PKCS8EncodedKeySpec formatted_private = new PKCS8EncodedKeySpec(Base64.getDecoder().decode(keyProperties.getEcdsaKey().getBase64PrivateKey()));
        X509EncodedKeySpec formatted_public = new X509EncodedKeySpec(Base64.getDecoder().decode(keyProperties.getEcdsaKey().getBase64PublicKey()));
